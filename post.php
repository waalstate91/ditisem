...
// Verder met het invoegen van gegevens in de database
// Verbinding maken met de database
$servername = "sql105.infinityfree.com";
$username = "if0_35122678"; // Jouw MySQL-gebruikersnaam
$password = "Verbond27!"; // Jouw MySQL-wachtwoord
$dbname = "if0_35122678_keepsimpel"; // Jouw database naam
...
// Gegevens invoegen in de tabel 'username'
$email = "voorbeeld@email.com";
$gebruikersnaam = "voorbeeldgebruiker";
$wachtwoord = "wachtwoord123"; // Zorg ervoor dat je het wachtwoord hash voordat je het opslaat!

$sql = "INSERT INTO username (email, gebruikersnaam, wachtwoord)
        VALUES ('$email', '$gebruikersnaam', '$wachtwoord')";

if ($conn->query($sql) === TRUE) {
    echo "Nieuwe rij toegevoegd aan de tabel 'username'";
} else {
    echo "Fout bij het invoegen van gegevens: " . $conn->error;
}
